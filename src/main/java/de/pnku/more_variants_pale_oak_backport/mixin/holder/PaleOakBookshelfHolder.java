...
public final class PaleOakBookshelfHolder {
    ...
    public static Block getBlock(WoodType woodType) {
        ...
        if (block == null) {
            throw new IllegalStateException("Bookshelf block is not registered for wood type: " + woodType);
        }
        return block;
    }
    ...
    public static Item getItem(WoodType woodType) {
        ...
        if (item == null) {
            throw new IllegalStateException("Bookshelf item is not registered for wood type: " + woodType);
        }
        return item;
    }
