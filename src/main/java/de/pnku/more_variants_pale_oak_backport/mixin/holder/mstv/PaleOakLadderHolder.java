...
public final class PaleOakLadderHolder {
    ...
    public static Block getBlock(WoodType woodType) {
        ...
        if (block == null) {
            throw new IllegalStateException("Ladder block is not registered for wood type: " + woodType);
        }
        return block;
    }
    ...
    public static Item getItem(WoodType woodType) {
        ...
        if (item == null) {
            throw new IllegalStateException("Ladder item is not registered for wood type: " + woodType);
        }
        return item;
    }

    private PaleOakLadderHolder() {
    }
}
