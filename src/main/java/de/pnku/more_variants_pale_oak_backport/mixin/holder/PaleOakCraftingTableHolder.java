...
public final class PaleOakCraftingTableHolder {
    ...
    public static Block getBlock(WoodType woodType) {
        ...
        if (block == null) {
            throw new IllegalStateException("Crafting table block is not registered for wood type: " + woodType);
        }
        return block;
    }
    ...
    public static Item getItem(WoodType woodType) {
        ...
        if (item == null) {
            throw new IllegalStateException("Crafting table item is not registered for wood type: " + woodType);
        }
        return item;
    }
