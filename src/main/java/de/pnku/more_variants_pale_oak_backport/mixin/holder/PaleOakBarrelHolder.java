...
public final class PaleOakBarrelHolder {
    ...
    public static Block getBlock(WoodType woodType) {
        ...
        if (block == null) {
            throw new IllegalStateException("Barrel block is not registered for wood type: " + woodType);
        }
        return block;
    }
    ...
    public static Item getItem(WoodType woodType) {
        ...
        if (item == null) {
            throw new IllegalStateException("Barrel item is not registered for wood type: " + woodType);
        }
        return item;
    }
