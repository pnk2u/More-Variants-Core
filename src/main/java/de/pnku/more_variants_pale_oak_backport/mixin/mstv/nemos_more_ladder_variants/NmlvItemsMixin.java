...
public abstract class NmlvItemsMixin {
    ...
    private static Item registerPaleOakLadderItem() {
        Item ladderItem = registerLadderBlockItem(WOOD_TYPE.getName() + "_ladder", PaleOakVariantHolder.getBlock(VariantType.LADDER, WOOD_TYPE));
        PaleOakVariantHolder.setItem(VariantType.LADDER, WOOD_TYPE, ladderItem);
        return ladderItem;
    }
}
