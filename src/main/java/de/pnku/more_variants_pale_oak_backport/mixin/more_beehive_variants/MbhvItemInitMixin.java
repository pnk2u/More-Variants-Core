...
public abstract class MbhvItemInitMixin {
    ...
    private static BlockItem registerPaleOakBeehiveItem() {
        BlockItem beehiveItem = new BlockItem(PaleOakVariantHolder.getBlock(VariantType.BEEHIVE, WOOD_TYPE), new Item.Properties());
        registerBeehiveItem(beehiveItem, Items.BEEHIVE);
        PaleOakVariantHolder.setItem(VariantType.BEEHIVE, WOOD_TYPE, beehiveItem);
        return beehiveItem;
    }
}
