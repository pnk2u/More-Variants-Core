...
public abstract class MftItemInitMixin {
    ...
    private static BlockItem registerPaleOakFletchingTableItem() {
        BlockItem fletchingTableItem = new BlockItem(PaleOakVariantHolder.getBlock(VariantType.FLETCHING_TABLE, WOOD_TYPE), new Item.Properties());
        registerItem(fletchingTableItem, Items.FLETCHING_TABLE);
        PaleOakVariantHolder.setItem(VariantType.FLETCHING_TABLE, WOOD_TYPE, fletchingTableItem);
